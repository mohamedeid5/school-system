...
<div class="modal fade" id="delete_fee{{$type->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('fees-type.destroy', $type->id)}}" method="post">
                    @csrf
                    @method('DELETE')
