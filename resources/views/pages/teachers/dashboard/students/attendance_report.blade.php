                        ...
                        <div class="row">
                            ...
                            <div class="card-body datepicker-form">
                                <div class="input-group" data-date-format="yyyy-mm-dd">
                                    <input type="text"  class="form-control range-from date-picker-default" value="{{ request('from') }}" placeholder="تاريخ البداية" required name="from">
                                    <span class="input-group-addon">الي تاريخ</span>
                                    <input class="form-control range-to date-picker-default" placeholder="تاريخ النهاية" value="{{ request('to') }}" type="text" required name="to">
                                </div>
                            </div>
                                ...
                                @foreach($studentsSearch as $student)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($student->attendance_status == 0)
