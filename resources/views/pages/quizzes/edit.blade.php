            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('quizzes.update', $quiz)}}" method="post" autocomplete="off">
                                @csrf
                                @method('PUT')
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="name_ar" value="{{ old('name_ar', $quiz->getTranslation('name', 'ar')) }}" class="form-control">
                                    </div>

                                    <div class="col">
                                        <label for="title">{{ __('quizzes.quiz_name_en') }}</label>
                                        <input type="text" name="name_en" value="{{ old('name_en', $quiz->getTranslation('name', 'en')) }}" class="form-control">
                                    </div>
                                </div>
                                <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="subject_id">
                                                ...
                                                @foreach($subjects as $subject)
                                                    <option  value="{{ $subject->id }}" {{ $subject->id == old('subject_id', $quiz->subject_id) ? 'selected' : '' }}>{{ $subject->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="teacher_id">
                                                ...
                                                @foreach($teachers as $teacher)
                                                    <option  value="{{ $teacher->id }}" {{ $teacher->id == old('teacher_id', $quiz->teacher_id) ? 'selected' : '' }}>{{ $teacher->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="grade_id">
                                                ...
                                                @foreach($grades as $grade)
                                                    <option  value="{{ $grade->id }}" {{ $grade->id == old('grade_id', $quiz->grade_id) ? 'selected' : '' }}>{{ $grade->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="classroom_id">
                                                ...
                                                @else
                                                    @foreach($classrooms as $classroom)
                                                        <option  value="{{ $classroom->id }}" {{ $classroom->id == $quiz->classroom_id ? 'selected' : '' }}>{{ $classroom->name }}</option>
                                                    @endforeach
                                                @endif
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="section_id">
                                                ...
                                                @else
                                                    @foreach($sections as $section)
                                                        <option  value="{{ $section->id }}" {{ $section->id == $quiz->section_id ? 'selected' : '' }}>{{ $section->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
